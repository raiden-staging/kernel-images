...
# Neko capture configuration mirrors the virtual media devices so that the WebRTC
# stack can surface the same camera/microphone into the live view.
NEKO_CAPTURE_AUDIO_DEVICE="${NEKO_CAPTURE_AUDIO_DEVICE:-audio_output.monitor}"
NEKO_CAPTURE_AUDIO_CODEC="${NEKO_CAPTURE_AUDIO_CODEC:-opus}"
NEKO_CAPTURE_MICROPHONE_ENABLED="${NEKO_CAPTURE_MICROPHONE_ENABLED:-true}"
NEKO_CAPTURE_MICROPHONE_DEVICE="${NEKO_CAPTURE_MICROPHONE_DEVICE:-$VIRTUAL_MEDIA_AUDIO_SINK}"
NEKO_CAPTURE_WEBCAM_ENABLED="${NEKO_CAPTURE_WEBCAM_ENABLED:-true}"
NEKO_CAPTURE_WEBCAM_DEVICE="${NEKO_CAPTURE_WEBCAM_DEVICE:-$VIRTUAL_MEDIA_VIDEO_DEVICE}"
NEKO_CAPTURE_WEBCAM_WIDTH="${NEKO_CAPTURE_WEBCAM_WIDTH:-$VIRTUAL_MEDIA_WEBCAM_WIDTH}"
NEKO_CAPTURE_WEBCAM_HEIGHT="${NEKO_CAPTURE_WEBCAM_HEIGHT:-$VIRTUAL_MEDIA_WEBCAM_HEIGHT}"
...
ensure_virtual_camera
if [[ -n "${VIRTUAL_MEDIA_VIDEO_UNAVAILABLE_REASON:-}" ]]; then
  NEKO_CAPTURE_WEBCAM_ENABLED="false"
  export NEKO_CAPTURE_WEBCAM_ENABLED
  echo "[virtual-media] Disabling Neko webcam capture: ${VIRTUAL_MEDIA_VIDEO_UNAVAILABLE_REASON}"
else
  echo "[virtual-media] Neko webcam capture enabled via ${NEKO_CAPTURE_WEBCAM_DEVICE} (${NEKO_CAPTURE_WEBCAM_WIDTH}x${NEKO_CAPTURE_WEBCAM_HEIGHT})"
fi
