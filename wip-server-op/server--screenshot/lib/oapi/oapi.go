...
// ScreenshotRegionRequest defines model for ScreenshotRegionRequest.
type ScreenshotRegionRequest struct {
...
// CaptureScreenshotRegionJSONRequestBody defines body for CaptureScreenshotRegion for application/json ContentType.
type CaptureScreenshotRegionJSONRequestBody = ScreenshotRegionRequest
...
type ClientInterface interface {
	// ClickMouse request with any body
	...
	// MoveMouse request with any body
	...
	// CreateDirectory request with any body
	...
	// DeleteDirectory request with any body
	...
	// DeleteFile request with any body
	...
	// MovePath request with any body
	...
	// SetFilePermissions request with any body
	...
	// StartFsWatch request with any body
	...
	// WriteFile request with any body
	...
	// DeleteRecording request with any body
	...
	// StartRecording request with any body
	...
	// StopRecording request with any body
	...
	CaptureScreenshot(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CaptureScreenshotRegion request with any body
	CaptureScreenshotRegionWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CaptureScreenshotRegion(ctx context.Context, body CaptureScreenshotRegionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) CaptureScreenshot(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCaptureScreenshotRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CaptureScreenshotRegionWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCaptureScreenshotRegionRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CaptureScreenshotRegion(ctx context.Context, body CaptureScreenshotRegionJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewCaptureScreenshotRegionRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewCaptureScreenshotRequest generates requests for CaptureScreenshot
func NewCaptureScreenshotRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/screenshot")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewCaptureScreenshotRegionRequest calls the generic CaptureScreenshotRegion builder with application/json body
func NewCaptureScreenshotRegionRequest(server string, body CaptureScreenshotRegionJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCaptureScreenshotRegionRequestWithBody(server, "application/json", bodyReader)
}

// NewCaptureScreenshotRegionRequestWithBody generates requests for CaptureScreenshotRegion with any type of body
func NewCaptureScreenshotRegionRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// CaptureScreenshot request
	CaptureScreenshotWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*CaptureScreenshotResponse, error)

	// CaptureScreenshotRegion request with any body
	CaptureScreenshotRegionWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CaptureScreenshotRegionResponse, error)

	CaptureScreenshotRegionWithResponse(ctx context.Context, body CaptureScreenshotRegionJSONRequestBody, reqEditors ...RequestEditorFn) (*CaptureScreenshotRegionResponse, error)
}
...
// Status returns HTTPResponse.Status
func (r CaptureScreenshotResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CaptureScreenshotResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type CaptureScreenshotRegionResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *Error
	JSON500      *Error
...
// Status returns HTTPResponse.Status
func (r CaptureScreenshotRegionResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CaptureScreenshotRegionResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// CaptureScreenshotWithResponse request returning *CaptureScreenshotResponse
func (c *ClientWithResponses) CaptureScreenshotWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*CaptureScreenshotResponse, error) {
	rsp, err := c.CaptureScreenshot(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCaptureScreenshotResponse(rsp)
}

// CaptureScreenshotRegionWithBodyWithResponse request with arbitrary body returning *CaptureScreenshotRegionResponse
func (c *ClientWithResponses) CaptureScreenshotRegionWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CaptureScreenshotRegionResponse, error) {
	rsp, err := c.CaptureScreenshotRegionWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCaptureScreenshotRegionResponse(rsp)
}

func (c *ClientWithResponses) CaptureScreenshotRegionWithResponse(ctx context.Context, body CaptureScreenshotRegionJSONRequestBody, reqEditors ...RequestEditorFn) (*CaptureScreenshotRegionResponse, error) {
	rsp, err := c.CaptureScreenshotRegion(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCaptureScreenshotRegionResponse(rsp)
...
// ParseCaptureScreenshotResponse parses an HTTP response from a CaptureScreenshotWithResponse call
func ParseCaptureScreenshotResponse(rsp *http.Response) (*CaptureScreenshotResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParseCaptureScreenshotRegionResponse parses an HTTP response from a CaptureScreenshotRegionWithResponse call
func ParseCaptureScreenshotRegionResponse(rsp *http.Response) (*CaptureScreenshotRegionResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &CaptureScreenshotRegionResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	// (GET /screenshot)
	CaptureScreenshot(w http.ResponseWriter, r *http.Request)
	// Capture a screenshot of a specific region
	// (POST /screenshot)
	CaptureScreenshotRegion(w http.ResponseWriter, r *http.Request)
}
...
func (siw *ServerInterfaceWrapper) StopFsWatch(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithLocation("simple", false, "watch_id", runtime.ParamLocationPath, chi.URLParam(r, "watch_id"), &watchId)
	if err != nil {
...
// CaptureScreenshot operation middleware
func (siw *ServerInterfaceWrapper) CaptureScreenshot(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CaptureScreenshot(w, r)
	})
...
// CaptureScreenshotRegion operation middleware
func (siw *ServerInterfaceWrapper) CaptureScreenshotRegion(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CaptureScreenshotRegion(w, r)
	})
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/screenshot", wrapper.CaptureScreenshot)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/screenshot", wrapper.CaptureScreenshotRegion)
	})
...
type CaptureScreenshotRequestObject struct {
}

type CaptureScreenshotResponseObject interface {
	VisitCaptureScreenshotResponse(w http.ResponseWriter) error
}

type CaptureScreenshot200ImagepngResponse struct {
	Body          io.Reader
	ContentLength int64
}

func (response CaptureScreenshot200ImagepngResponse) VisitCaptureScreenshotResponse(w http.ResponseWriter) error {
...
type CaptureScreenshot500JSONResponse struct{ InternalErrorJSONResponse }

func (response CaptureScreenshot500JSONResponse) VisitCaptureScreenshotResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type CaptureScreenshotRegionRequestObject struct {
	Body *CaptureScreenshotRegionJSONRequestBody
}

type CaptureScreenshotRegionResponseObject interface {
	VisitCaptureScreenshotRegionResponse(w http.ResponseWriter) error
}

type CaptureScreenshotRegion200ImagepngResponse struct {
	Body          io.Reader
	ContentLength int64
}

func (response CaptureScreenshotRegion200ImagepngResponse) VisitCaptureScreenshotRegionResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "image/png")
	if response.ContentLength != 0 {
		w.Header().Set("Content-Length", fmt.Sprint(response.ContentLength))
	}
...
type CaptureScreenshotRegion400JSONResponse struct{ BadRequestErrorJSONResponse }

func (response CaptureScreenshotRegion400JSONResponse) VisitCaptureScreenshotRegionResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type CaptureScreenshotRegion500JSONResponse struct{ InternalErrorJSONResponse }

func (response CaptureScreenshotRegion500JSONResponse) VisitCaptureScreenshotRegionResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
// CaptureScreenshot operation middleware
func (sh *strictHandler) CaptureScreenshot(w http.ResponseWriter, r *http.Request) {
	var request CaptureScreenshotRequestObject

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.CaptureScreenshot(ctx, request.(CaptureScreenshotRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "CaptureScreenshot")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(CaptureScreenshotResponseObject); ok {
		if err := validResponse.VisitCaptureScreenshotResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("Unexpected response type: %T", response))
...
// CaptureScreenshotRegion operation middleware
func (sh *strictHandler) CaptureScreenshotRegion(w http.ResponseWriter, r *http.Request) {
	var request CaptureScreenshotRegionRequestObject

	var body CaptureScreenshotRegionJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.