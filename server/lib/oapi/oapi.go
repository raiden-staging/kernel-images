...
// Defines values for VirtualMediaPipelineStatusState.
const (
	VirtualMediaPipelineStatusStatePaused  VirtualMediaPipelineStatusState = "paused"
	VirtualMediaPipelineStatusStateRunning VirtualMediaPipelineStatusState = "running"
	VirtualMediaPipelineStatusStateStopped VirtualMediaPipelineStatusState = "stopped"
)

// Defines values for VirtualMediaSourceType.
const (
	File   VirtualMediaSourceType = "file"
	Stream VirtualMediaSourceType = "stream"
)

// Defines values for VirtualMediaStatusState.
const (
	Paused  VirtualMediaStatusState = "paused"
	Running VirtualMediaStatusState = "running"
	Stopped VirtualMediaStatusState = "stopped"
)
...
// VirtualMediaConfig defines model for VirtualMediaConfig.
type VirtualMediaConfig struct {
	Audio *VirtualMediaSource `json:"audio,omitempty"`
	Video *VirtualMediaSource `json:"video,omitempty"`
}

// VirtualMediaPipelineStatus defines model for VirtualMediaPipelineStatus.
type VirtualMediaPipelineStatus struct {
	// Pid PID of the active ffmpeg process (when running)
	Pid    *int                `json:"pid,omitempty"`
	Source *VirtualMediaSource `json:"source,omitempty"`

	// State Current state of the pipeline
	State VirtualMediaPipelineStatusState `json:"state"`
}

// VirtualMediaPipelineStatusState Current state of the pipeline
type VirtualMediaPipelineStatusState string

// VirtualMediaSource defines model for VirtualMediaSource.
type VirtualMediaSource struct {
	// Loop Whether to loop the input when type is "file".
	Loop *bool `json:"loop,omitempty"`

	// Type Source type. Streams cover HLS/RTMP(S)/DASH; files support looping.
	Type *VirtualMediaSourceType `json:"type,omitempty"`

	// Url Source URL for the virtual media pipeline (file or stream).
	Url string `json:"url"`
}

// VirtualMediaSourceType Source type. Streams cover HLS/RTMP(S)/DASH; files support looping.
type VirtualMediaSourceType string

// VirtualMediaStatus defines model for VirtualMediaStatus.
type VirtualMediaStatus struct {
	Audio *VirtualMediaPipelineStatus `json:"audio,omitempty"`

	// AudioSink PulseAudio sink used to feed the virtual microphone
	AudioSink *string `json:"audio_sink,omitempty"`

	// State Aggregated state across audio/video pipelines
	State VirtualMediaStatusState     `json:"state"`
	Video *VirtualMediaPipelineStatus `json:"video,omitempty"`

	// VideoDevice Virtual camera device path
	VideoDevice *string `json:"video_device,omitempty"`
}

// VirtualMediaStatusState Aggregated state across audio/video pipelines
type VirtualMediaStatusState string
...
// SetVirtualMediaJSONRequestBody defines body for SetVirtualMedia for application/json ContentType.
type SetVirtualMediaJSONRequestBody = VirtualMediaConfig
...
type ClientInterface interface {
	...
	// GetVirtualMediaStatus request
	GetVirtualMediaStatus(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SetVirtualMediaWithBody request with any body
	SetVirtualMediaWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SetVirtualMedia(ctx context.Context, body SetVirtualMediaJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PauseVirtualMedia request
	PauseVirtualMedia(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ResumeVirtualMedia request
	ResumeVirtualMedia(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetVirtualMediaStatus(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetVirtualMediaStatusRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SetVirtualMediaWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSetVirtualMediaRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) SetVirtualMedia(ctx context.Context, body SetVirtualMediaJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewSetVirtualMediaRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PauseVirtualMedia(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPauseVirtualMediaRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ResumeVirtualMedia(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewResumeVirtualMediaRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewStopVirtualMediaRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/virtual_media")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetVirtualMediaStatusRequest generates requests for GetVirtualMediaStatus
func NewGetVirtualMediaStatusRequest(server string) (*http.Request, error) {
	var err error
...
// NewSetVirtualMediaRequest calls the generic SetVirtualMedia builder with application/json body
func NewSetVirtualMediaRequest(server string, body SetVirtualMediaJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSetVirtualMediaRequestWithBody(server, "application/json", bodyReader)
}

// NewSetVirtualMediaRequestWithBody generates requests for SetVirtualMedia with any type of body
func NewSetVirtualMediaRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewPauseVirtualMediaRequest generates requests for PauseVirtualMedia
func NewPauseVirtualMediaRequest(server string) (*http.Request, error) {
	var err error
...
// NewResumeVirtualMediaRequest generates requests for ResumeVirtualMedia
func NewResumeVirtualMediaRequest(server string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetVirtualMediaStatusWithResponse request
	GetVirtualMediaStatusWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetVirtualMediaStatusResponse, error)

	// SetVirtualMediaWithBodyWithResponse request with any body
	SetVirtualMediaWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SetVirtualMediaResponse, error)

	SetVirtualMediaWithResponse(ctx context.Context, body SetVirtualMediaJSONRequestBody, reqEditors ...RequestEditorFn) (*SetVirtualMediaResponse, error)

	// PauseVirtualMediaWithResponse request
	PauseVirtualMediaWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PauseVirtualMediaResponse, error)

	// ResumeVirtualMediaWithResponse request
	ResumeVirtualMediaWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*ResumeVirtualMediaResponse, error)
}
...
type GetVirtualMediaStatusResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *VirtualMediaStatus
	JSON500      *InternalError
...
// Status returns HTTPResponse.Status
func (r GetVirtualMediaStatusResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetVirtualMediaStatusResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type SetVirtualMediaResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *VirtualMediaStatus
	JSON400      *BadRequestError
...
// Status returns HTTPResponse.Status
func (r SetVirtualMediaResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r SetVirtualMediaResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetVirtualMediaStatusWithResponse request returning *GetVirtualMediaStatusResponse
func (c *ClientWithResponses) GetVirtualMediaStatusWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetVirtualMediaStatusResponse, error) {
	rsp, err := c.GetVirtualMediaStatus(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetVirtualMediaStatusResponse(rsp)
}

// SetVirtualMediaWithBodyWithResponse request with arbitrary body returning *SetVirtualMediaResponse
func (c *ClientWithResponses) SetVirtualMediaWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SetVirtualMediaResponse, error) {
	rsp, err := c.SetVirtualMediaWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSetVirtualMediaResponse(rsp)
}

func (c *ClientWithResponses) SetVirtualMediaWithResponse(ctx context.Context, body SetVirtualMediaJSONRequestBody, reqEditors ...RequestEditorFn) (*SetVirtualMediaResponse, error) {
	rsp, err := c.SetVirtualMedia(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSetVirtualMediaResponse(rsp)
...
// PauseVirtualMediaWithResponse request returning *PauseVirtualMediaResponse
func (c *ClientWithResponses) PauseVirtualMediaWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PauseVirtualMediaResponse, error) {
	rsp, err := c.PauseVirtualMedia(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ResumeVirtualMediaWithResponse request returning *ResumeVirtualMediaResponse
func (c *ClientWithResponses) ResumeVirtualMediaWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*ResumeVirtualMediaResponse, error) {
	rsp, err := c.ResumeVirtualMedia(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// ParseGetVirtualMediaStatusResponse parses an HTTP response from a GetVirtualMediaStatusWithResponse call
func ParseGetVirtualMediaStatusResponse(rsp *http.Response) (*GetVirtualMediaStatusResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetVirtualMediaStatusResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseSetVirtualMediaResponse parses an HTTP response from a SetVirtualMediaWithResponse call
func ParseSetVirtualMediaResponse(rsp *http.Response) (*SetVirtualMediaResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &SetVirtualMediaResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	// Stop virtual media input pipelines
	// (DELETE /virtual_media)
	StopVirtualMedia(w http.ResponseWriter, r *http.Request)
	// Get virtual media status
	// (GET /virtual_media)
	GetVirtualMediaStatus(w http.ResponseWriter, r *http.Request)
	// Start or update virtual camera/microphone input pipelines
	// (PUT /virtual_media)
	SetVirtualMedia(w http.ResponseWriter, r *http.Request)
	// Pause active virtual media pipelines
	// (POST /virtual_media/pause)
	PauseVirtualMedia(w http.ResponseWriter, r *http.Request)
	// Resume paused virtual media pipelines
...
// Get virtual media status
// (GET /virtual_media)
func (_ Unimplemented) GetVirtualMediaStatus(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Start or update virtual camera/microphone input pipelines
// (PUT /virtual_media)
func (_ Unimplemented) SetVirtualMedia(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// GetVirtualMediaStatus operation middleware
func (siw *ServerInterfaceWrapper) GetVirtualMediaStatus(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetVirtualMediaStatus(w, r)
	}))
...
// SetVirtualMedia operation middleware
func (siw *ServerInterfaceWrapper) SetVirtualMedia(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SetVirtualMedia(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/virtual_media", wrapper.StopVirtualMedia)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/virtual_media", wrapper.GetVirtualMediaStatus)
	})
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/virtual_media", wrapper.SetVirtualMedia)
	})
	r.Group(func(r chi.Router) {
...
type GetVirtualMediaStatusRequestObject struct {
}

type GetVirtualMediaStatusResponseObject interface {
	VisitGetVirtualMediaStatusResponse(w http.ResponseWriter) error
}

type GetVirtualMediaStatus200JSONResponse VirtualMediaStatus

func (response GetVirtualMediaStatus200JSONResponse) VisitGetVirtualMediaStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type GetVirtualMediaStatus500JSONResponse struct{ InternalErrorJSONResponse }

func (response GetVirtualMediaStatus500JSONResponse) VisitGetVirtualMediaStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type SetVirtualMediaRequestObject struct {
	Body *SetVirtualMediaJSONRequestBody
}

type SetVirtualMediaResponseObject interface {
	VisitSetVirtualMediaResponse(w http.ResponseWriter) error
}

type SetVirtualMedia200JSONResponse VirtualMediaStatus

func (response SetVirtualMedia200JSONResponse) VisitSetVirtualMediaResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type SetVirtualMedia400JSONResponse struct{ BadRequestErrorJSONResponse }

func (response SetVirtualMedia400JSONResponse) VisitSetVirtualMediaResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type SetVirtualMedia500JSONResponse struct{ InternalErrorJSONResponse }

func (response SetVirtualMedia500JSONResponse) VisitSetVirtualMediaResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StrictServerInterface interface {
	...
	// Get virtual media status
	// (GET /virtual_media)
	GetVirtualMediaStatus(ctx context.Context, request GetVirtualMediaStatusRequestObject) (GetVirtualMediaStatusResponseObject, error)
	// Start or update virtual camera/microphone input pipelines
	// (PUT /virtual_media)
	SetVirtualMedia(ctx context.Context, request SetVirtualMediaRequestObject) (SetVirtualMediaResponseObject, error)
	// Pause active virtual media pipelines
	// (POST /virtual_media/pause)
...
// GetVirtualMediaStatus operation middleware
func (sh *strictHandler) GetVirtualMediaStatus(w http.ResponseWriter, r *http.Request) {
	var request GetVirtualMediaStatusRequestObject

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetVirtualMediaStatus(ctx, request.(GetVirtualMediaStatusRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetVirtualMediaStatus")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(GetVirtualMediaStatusResponseObject); ok {
		if err := validResponse.VisitGetVirtualMediaStatusResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// SetVirtualMedia operation middleware
func (sh *strictHandler) SetVirtualMedia(w http.ResponseWriter, r *http.Request) {
	var request SetVirtualMediaRequestObject

	var body SetVirtualMediaJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.SetVirtualMedia(ctx, request.(SetVirtualMediaRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "SetVirtualMedia")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(SetVirtualMediaResponseObject); ok {
		if err := validResponse.VisitSetVirtualMediaResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+x9e3PbNrb4V8HwtzOxf6uH8+pO3b/c2Gl9kzQey9nsbZ2rhcgjCWsSYAFQspLxd7+D",
	"A/AlgnrZju3OndnZOiIJHJwXzgsH34JQJKngwLUKDr8FElQquAL8x880Ooc/M1D6REohzU+h4Bq4Nn/S",
	"NI1ZSDUTvP8fJbj5TYVTSKj5628SxsFh8P/65fh9+1T17Wg3NzedIAIVSpaaQYJDMyFxMwY3neCN4OOY",
	"hd9r9nw6M/Up1yA5jb/T1Pl0ZAByBpK4FzvBb0K/FRmPvhMcvwlNcL7APHOvm9HexCy8+iAyBTl9DABR",
	"xMyHND6TIgWpmeGbMY0VdIK08tO3YJRpbSGsT4hDEvuUaEGYQQQNNZkzPQ06AfAsCQ7/CGIY66ATSDaZ",
	"mv8mLIpiCDrBiIZXQScYCzmnMgq+dAK9SCE4DJSWjE8MCkMD+tD+vDz9xSIFIsYE3yE0xJ/LWSMxN//M",
	"0sAN451gKuJoeAUL5VtexMYMJDGPzfrMuyTKzKdET8FOHHQCpiHB7xujux+olHRh/s2zZIhfuenGNIt1",
	"cPi8QcosGYE0i9MsAZxcQgpU1+Z1oxu0TwA57rq5in+RUAgZMU41YqsYgKRCMYez5kiL5kj/vctIN51A",
	"wp8ZkxAZolwHZuiSEGL0H7BC+0YC1XDMJIRayMVunJqIyMMoH1P7OYny0Yl5keyJUNOYWHJ1CPQmPfKP",
	"16/3e+TYUgYR/4/Xr3tBJ0ipNmIeHAb/88dB9x9fvr3svLr5W+BhqZTqaROIo5EScaahAoR50cwQ4tKX",
	"Jun3/n9z8CVs4kw+ZB5DDBrOqJ7uhsc1S8gBj3Cauwf8HEJktMlu0LOoCftpBFxbcXasK/NJKishR3E6",
	"pTxLQLKQCEmmi3QKfJn+tPv1qPv7QffH7pe//8272ObCmEpjujDbFJtsuZ4poOZsrOlNJiVwTSI7NrHv",
	"EcZJyq4hVl7BljCWoKZDSTWsH9K9TczbZuBfv5K9hC7ICAjP4piwMeFCkwg0hJqOYtj3TjpnkY+hlmfD",
	"11bC70WtpJPvsLtFkk5adrZiR7NbnG+fiSCmi5rSP1hW+sfmFbP6hMUxUxAKHikyAj0H4DkgZlcjlEdE",
	"aSq1495EzIDQWLh9yUhXD8HiLDGAHvhocpudz+Biq43Pr1A+yggkRCRmShux/OO6QxZfqttMSplUxRL1",
