...
// Defines values for MediaInputStatusMediaType.
const (
	MediaInputStatusMediaTypeAudio MediaInputStatusMediaType = "audio"
	MediaInputStatusMediaTypeBoth  MediaInputStatusMediaType = "both"
	MediaInputStatusMediaTypeVideo MediaInputStatusMediaType = "video"
)

// Defines values for MediaInputStatusState.
const (
	Paused  MediaInputStatusState = "paused"
	Playing MediaInputStatusState = "playing"
	Stopped MediaInputStatusState = "stopped"
)
...
// Defines values for StartMediaInputRequestMediaType.
const (
	StartMediaInputRequestMediaTypeAudio StartMediaInputRequestMediaType = "audio"
	StartMediaInputRequestMediaTypeBoth  StartMediaInputRequestMediaType = "both"
	StartMediaInputRequestMediaTypeVideo StartMediaInputRequestMediaType = "video"
)
...
// MediaInputStatus Current status of virtual media input
type MediaInputStatus struct {
	// Active Whether a media input stream is currently active
	Active bool `json:"active"`

	// Loop Whether looping is enabled
	Loop *bool `json:"loop,omitempty"`

	// MediaType Type of media being streamed
	MediaType *MediaInputStatusMediaType `json:"mediaType,omitempty"`

	// StartedAt Timestamp when the stream started
	StartedAt *time.Time `json:"startedAt,omitempty"`

	// State Current playback state
	State MediaInputStatusState `json:"state"`

	// Url URL of the current stream (if active)
	Url *string `json:"url,omitempty"`
}

// MediaInputStatusMediaType Type of media being streamed
type MediaInputStatusMediaType string

// MediaInputStatusState Current playback state
type MediaInputStatusState string
...
// StartMediaInputRequest Request to start media input streaming
type StartMediaInputRequest struct {
	// Loop Loop the media (only works for file inputs, not live streams)
	Loop *bool `json:"loop,omitempty"`

	// MediaType Type of media to stream (video only, audio only, or both)
	MediaType StartMediaInputRequestMediaType `json:"mediaType"`

	// Url Media source URL. Supports:
	// - Streaming protocols: HLS (http://example.com/stream.m3u8), RTMP (rtmp://example.com/live/stream), DASH (http://example.com/manifest.mpd)
	// - File URLs: http://example.com/video.mp4, file:///path/to/video.mp4
	Url string `json:"url"`

	// VideoDevice Virtual video device path. Defaults to /dev/video10
	VideoDevice *string `json:"videoDevice,omitempty"`
}

// StartMediaInputRequestMediaType Type of media to stream (video only, audio only, or both)
type StartMediaInputRequestMediaType string
...
// PauseMediaInputJSONBody defines parameters for PauseMediaInput.
type PauseMediaInputJSONBody = map[string]interface{}

// ResumeMediaInputJSONBody defines parameters for ResumeMediaInput.
type ResumeMediaInputJSONBody = map[string]interface{}

// StopMediaInputJSONBody defines parameters for StopMediaInput.
type StopMediaInputJSONBody = map[string]interface{}
...
// PauseMediaInputJSONRequestBody defines body for PauseMediaInput for application/json ContentType.
type PauseMediaInputJSONRequestBody = PauseMediaInputJSONBody

// ResumeMediaInputJSONRequestBody defines body for ResumeMediaInput for application/json ContentType.
type ResumeMediaInputJSONRequestBody = ResumeMediaInputJSONBody

// StartMediaInputJSONRequestBody defines body for StartMediaInput for application/json ContentType.
type StartMediaInputJSONRequestBody = StartMediaInputRequest

// StopMediaInputJSONRequestBody defines body for StopMediaInput for application/json ContentType.
type StopMediaInputJSONRequestBody = StopMediaInputJSONBody
...
type ClientInterface interface {
	...
	// PauseMediaInputWithBody request with any body
	PauseMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PauseMediaInput(ctx context.Context, body PauseMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// ResumeMediaInputWithBody request with any body
	ResumeMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	ResumeMediaInput(ctx context.Context, body ResumeMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// StartMediaInputWithBody request with any body
	StartMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StartMediaInput(ctx context.Context, body StartMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetMediaInputStatus request
	GetMediaInputStatus(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// StopMediaInputWithBody request with any body
	StopMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	StopMediaInput(ctx context.Context, body StopMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PauseMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPauseMediaInputRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PauseMediaInput(ctx context.Context, body PauseMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPauseMediaInputRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ResumeMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewResumeMediaInputRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) ResumeMediaInput(ctx context.Context, body ResumeMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewResumeMediaInputRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StartMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStartMediaInputRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StartMediaInput(ctx context.Context, body StartMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStartMediaInputRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetMediaInputStatus(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetMediaInputStatusRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StopMediaInputWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStopMediaInputRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) StopMediaInput(ctx context.Context, body StopMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewStopMediaInputRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPauseMediaInputRequest calls the generic PauseMediaInput builder with application/json body
func NewPauseMediaInputRequest(server string, body PauseMediaInputJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPauseMediaInputRequestWithBody(server, "application/json", bodyReader)
}

// NewPauseMediaInputRequestWithBody generates requests for PauseMediaInput with any type of body
func NewPauseMediaInputRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/media/input/pause")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewResumeMediaInputRequest calls the generic ResumeMediaInput builder with application/json body
func NewResumeMediaInputRequest(server string, body ResumeMediaInputJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewResumeMediaInputRequestWithBody(server, "application/json", bodyReader)
}

// NewResumeMediaInputRequestWithBody generates requests for ResumeMediaInput with any type of body
func NewResumeMediaInputRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/media/input/resume")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewStartMediaInputRequest calls the generic StartMediaInput builder with application/json body
func NewStartMediaInputRequest(server string, body StartMediaInputJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStartMediaInputRequestWithBody(server, "application/json", bodyReader)
}

// NewStartMediaInputRequestWithBody generates requests for StartMediaInput with any type of body
func NewStartMediaInputRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/media/input/start")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetMediaInputStatusRequest generates requests for GetMediaInputStatus
func NewGetMediaInputStatusRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/media/input/status")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewStopMediaInputRequest calls the generic StopMediaInput builder with application/json body
func NewStopMediaInputRequest(server string, body StopMediaInputJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewStopMediaInputRequestWithBody(server, "application/json", bodyReader)
}

// NewStopMediaInputRequestWithBody generates requests for StopMediaInput with any type of body
func NewStopMediaInputRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/media/input/stop")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PauseMediaInputWithBodyWithResponse request with any body
	PauseMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PauseMediaInputResponse, error)

	PauseMediaInputWithResponse(ctx context.Context, body PauseMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*PauseMediaInputResponse, error)

	// ResumeMediaInputWithBodyWithResponse request with any body
	ResumeMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ResumeMediaInputResponse, error)

	ResumeMediaInputWithResponse(ctx context.Context, body ResumeMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*ResumeMediaInputResponse, error)

	// StartMediaInputWithBodyWithResponse request with any body
	StartMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StartMediaInputResponse, error)

	StartMediaInputWithResponse(ctx context.Context, body StartMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*StartMediaInputResponse, error)

	// GetMediaInputStatusWithResponse request
	GetMediaInputStatusWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetMediaInputStatusResponse, error)

	// StopMediaInputWithBodyWithResponse request with any body
	StopMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StopMediaInputResponse, error)

	StopMediaInputWithResponse(ctx context.Context, body StopMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*StopMediaInputResponse, error)
...
type PauseMediaInputResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *BadRequestError
	JSON500      *InternalError
...
// Status returns HTTPResponse.Status
func (r PauseMediaInputResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PauseMediaInputResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type ResumeMediaInputResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *BadRequestError
	JSON500      *InternalError
...
// Status returns HTTPResponse.Status
func (r ResumeMediaInputResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ResumeMediaInputResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type StartMediaInputResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *BadRequestError
	JSON409      *ConflictError
...
// Status returns HTTPResponse.Status
func (r StartMediaInputResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r StartMediaInputResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetMediaInputStatusResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *MediaInputStatus
	JSON500      *InternalError
}

// Status returns HTTPResponse.Status
func (r GetMediaInputStatusResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetMediaInputStatusResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type StopMediaInputResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON400      *BadRequestError
	JSON500      *InternalError
...
// Status returns HTTPResponse.Status
func (r StopMediaInputResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r StopMediaInputResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PauseMediaInputWithBodyWithResponse request with arbitrary body returning *PauseMediaInputResponse
func (c *ClientWithResponses) PauseMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PauseMediaInputResponse, error) {
	rsp, err := c.PauseMediaInputWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePauseMediaInputResponse(rsp)
}

func (c *ClientWithResponses) PauseMediaInputWithResponse(ctx context.Context, body PauseMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*PauseMediaInputResponse, error) {
	rsp, err := c.PauseMediaInput(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePauseMediaInputResponse(rsp)
...
// ResumeMediaInputWithBodyWithResponse request with arbitrary body returning *ResumeMediaInputResponse
func (c *ClientWithResponses) ResumeMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*ResumeMediaInputResponse, error) {
	rsp, err := c.ResumeMediaInputWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseResumeMediaInputResponse(rsp)
}

func (c *ClientWithResponses) ResumeMediaInputWithResponse(ctx context.Context, body ResumeMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*ResumeMediaInputResponse, error) {
	rsp, err := c.ResumeMediaInput(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseResumeMediaInputResponse(rsp)
...
// StartMediaInputWithBodyWithResponse request with arbitrary body returning *StartMediaInputResponse
func (c *ClientWithResponses) StartMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StartMediaInputResponse, error) {
	rsp, err := c.StartMediaInputWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStartMediaInputResponse(rsp)
}

func (c *ClientWithResponses) StartMediaInputWithResponse(ctx context.Context, body StartMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*StartMediaInputResponse, error) {
	rsp, err := c.StartMediaInput(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStartMediaInputResponse(rsp)
...
// GetMediaInputStatusWithResponse request returning *GetMediaInputStatusResponse
func (c *ClientWithResponses) GetMediaInputStatusWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetMediaInputStatusResponse, error) {
	rsp, err := c.GetMediaInputStatus(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetMediaInputStatusResponse(rsp)
}

// StopMediaInputWithBodyWithResponse request with arbitrary body returning *StopMediaInputResponse
func (c *ClientWithResponses) StopMediaInputWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*StopMediaInputResponse, error) {
	rsp, err := c.StopMediaInputWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStopMediaInputResponse(rsp)
}

func (c *ClientWithResponses) StopMediaInputWithResponse(ctx context.Context, body StopMediaInputJSONRequestBody, reqEditors ...RequestEditorFn) (*StopMediaInputResponse, error) {
	rsp, err := c.StopMediaInput(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseStopMediaInputResponse(rsp)
...
// ParsePauseMediaInputResponse parses an HTTP response from a PauseMediaInputWithResponse call
func ParsePauseMediaInputResponse(rsp *http.Response) (*PauseMediaInputResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PauseMediaInputResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseResumeMediaInputResponse parses an HTTP response from a ResumeMediaInputWithResponse call
func ParseResumeMediaInputResponse(rsp *http.Response) (*ResumeMediaInputResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ResumeMediaInputResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseStartMediaInputResponse parses an HTTP response from a StartMediaInputWithResponse call
func ParseStartMediaInputResponse(rsp *http.Response) (*StartMediaInputResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &StartMediaInputResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetMediaInputStatusResponse parses an HTTP response from a GetMediaInputStatusWithResponse call
func ParseGetMediaInputStatusResponse(rsp *http.Response) (*GetMediaInputStatusResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetMediaInputStatusResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseStopMediaInputResponse parses an HTTP response from a StopMediaInputWithResponse call
func ParseStopMediaInputResponse(rsp *http.Response) (*StopMediaInputResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &StopMediaInputResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
type ServerInterface interface {
	...
	// Pause the active media input stream
	// (POST /media/input/pause)
	PauseMediaInput(w http.ResponseWriter, r *http.Request)
	// Resume a paused media input stream
	// (POST /media/input/resume)
	ResumeMediaInput(w http.ResponseWriter, r *http.Request)
	// Start streaming media to virtual input devices
	// (POST /media/input/start)
	StartMediaInput(w http.ResponseWriter, r *http.Request)
	// Get the status of virtual media input
	// (GET /media/input/status)
	GetMediaInputStatus(w http.ResponseWriter, r *http.Request)
	// Stop the active media input stream
	// (POST /media/input/stop)
	StopMediaInput(w http.ResponseWriter, r *http.Request)
...
// Pause the active media input stream
// (POST /media/input/pause)
func (_ Unimplemented) PauseMediaInput(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Resume a paused media input stream
// (POST /media/input/resume)
func (_ Unimplemented) ResumeMediaInput(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Start streaming media to virtual input devices
// (POST /media/input/start)
func (_ Unimplemented) StartMediaInput(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Get the status of virtual media input
// (GET /media/input/status)
func (_ Unimplemented) GetMediaInputStatus(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Stop the active media input stream
// (POST /media/input/stop)
func (_ Unimplemented) StopMediaInput(w http.ResponseWriter, r *http.Request) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// PauseMediaInput operation middleware
func (siw *ServerInterfaceWrapper) PauseMediaInput(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PauseMediaInput(w, r)
	}))
...
// ResumeMediaInput operation middleware
func (siw *ServerInterfaceWrapper) ResumeMediaInput(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ResumeMediaInput(w, r)
	}))
...
// StartMediaInput operation middleware
func (siw *ServerInterfaceWrapper) StartMediaInput(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.StartMediaInput(w, r)
	}))
...
// GetMediaInputStatus operation middleware
func (siw *ServerInterfaceWrapper) GetMediaInputStatus(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMediaInputStatus(w, r)
	}))
...
// StopMediaInput operation middleware
func (siw *ServerInterfaceWrapper) StopMediaInput(w http.ResponseWriter, r *http.Request) {

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.StopMediaInput(w, r)
	}))
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/media/input/pause", wrapper.PauseMediaInput)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/media/input/resume", wrapper.ResumeMediaInput)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/media/input/start", wrapper.StartMediaInput)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/media/input/status", wrapper.GetMediaInputStatus)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/media/input/stop", wrapper.StopMediaInput)
	})
	r.Group(func(r chi.Router) {
...
type PauseMediaInputRequestObject struct {
	Body *PauseMediaInputJSONRequestBody
}

type PauseMediaInputResponseObject interface {
	VisitPauseMediaInputResponse(w http.ResponseWriter) error
}

type PauseMediaInput200Response struct {
}

func (response PauseMediaInput200Response) VisitPauseMediaInputResponse(w http.ResponseWriter) error {
	w.WriteHeader(200)
	return nil
}

type PauseMediaInput400JSONResponse struct{ BadRequestErrorJSONResponse }

func (response PauseMediaInput400JSONResponse) VisitPauseMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type PauseMediaInput500JSONResponse struct{ InternalErrorJSONResponse }

func (response PauseMediaInput500JSONResponse) VisitPauseMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type ResumeMediaInputRequestObject struct {
	Body *ResumeMediaInputJSONRequestBody
}

type ResumeMediaInputResponseObject interface {
	VisitResumeMediaInputResponse(w http.ResponseWriter) error
}

type ResumeMediaInput200Response struct {
}

func (response ResumeMediaInput200Response) VisitResumeMediaInputResponse(w http.ResponseWriter) error {
	w.WriteHeader(200)
	return nil
}

type ResumeMediaInput400JSONResponse struct{ BadRequestErrorJSONResponse }

func (response ResumeMediaInput400JSONResponse) VisitResumeMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type ResumeMediaInput500JSONResponse struct{ InternalErrorJSONResponse }

func (response ResumeMediaInput500JSONResponse) VisitResumeMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StartMediaInputRequestObject struct {
	Body *StartMediaInputJSONRequestBody
}

type StartMediaInputResponseObject interface {
	VisitStartMediaInputResponse(w http.ResponseWriter) error
}

type StartMediaInput201Response struct {
}

func (response StartMediaInput201Response) VisitStartMediaInputResponse(w http.ResponseWriter) error {
	w.WriteHeader(201)
	return nil
}

type StartMediaInput400JSONResponse struct{ BadRequestErrorJSONResponse }

func (response StartMediaInput400JSONResponse) VisitStartMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type StartMediaInput409JSONResponse struct{ ConflictErrorJSONResponse }

func (response StartMediaInput409JSONResponse) VisitStartMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(409)
...
type StartMediaInput500JSONResponse struct{ InternalErrorJSONResponse }

func (response StartMediaInput500JSONResponse) VisitStartMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type GetMediaInputStatusRequestObject struct {
}

type GetMediaInputStatusResponseObject interface {
	VisitGetMediaInputStatusResponse(w http.ResponseWriter) error
}

type GetMediaInputStatus200JSONResponse MediaInputStatus

func (response GetMediaInputStatus200JSONResponse) VisitGetMediaInputStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type GetMediaInputStatus500JSONResponse struct{ InternalErrorJSONResponse }

func (response GetMediaInputStatus500JSONResponse) VisitGetMediaInputStatusResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StopMediaInputRequestObject struct {
	Body *StopMediaInputJSONRequestBody
}

type StopMediaInputResponseObject interface {
	VisitStopMediaInputResponse(w http.ResponseWriter) error
}

type StopMediaInput200Response struct {
}

func (response StopMediaInput200Response) VisitStopMediaInputResponse(w http.ResponseWriter) error {
	w.WriteHeader(200)
	return nil
}

type StopMediaInput400JSONResponse struct{ BadRequestErrorJSONResponse }

func (response StopMediaInput400JSONResponse) VisitStopMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type StopMediaInput500JSONResponse struct{ InternalErrorJSONResponse }

func (response StopMediaInput500JSONResponse) VisitStopMediaInputResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
type StrictServerInterface interface {
	...
	// Pause the active media input stream
	// (POST /media/input/pause)
	PauseMediaInput(ctx context.Context, request PauseMediaInputRequestObject) (PauseMediaInputResponseObject, error)
	// Resume a paused media input stream
	// (POST /media/input/resume)
	ResumeMediaInput(ctx context.Context, request ResumeMediaInputRequestObject) (ResumeMediaInputResponseObject, error)
	// Start streaming media to virtual input devices
	// (POST /media/input/start)
	StartMediaInput(ctx context.Context, request StartMediaInputRequestObject) (StartMediaInputResponseObject, error)
	// Get the status of virtual media input
	// (GET /media/input/status)
	GetMediaInputStatus(ctx context.Context, request GetMediaInputStatusRequestObject) (GetMediaInputStatusResponseObject, error)
	// Stop the active media input stream
	// (POST /media/input/stop)
	StopMediaInput(ctx context.Context, request StopMediaInputRequestObject) (StopMediaInputResponseObject, error)
	// Execute Playwright/TypeScript code against the browser
	// (POST /playwright/execute)
...
// PauseMediaInput operation middleware
func (sh *strictHandler) PauseMediaInput(w http.ResponseWriter, r *http.Request) {
	var request PauseMediaInputRequestObject

	var body PauseMediaInputJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.PauseMediaInput(ctx, request.(PauseMediaInputRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "PauseMediaInput")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(PauseMediaInputResponseObject); ok {
		if err := validResponse.VisitPauseMediaInputResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// ResumeMediaInput operation middleware
func (sh *strictHandler) ResumeMediaInput(w http.ResponseWriter, r *http.Request) {
	var request ResumeMediaInputRequestObject

	var body ResumeMediaInputJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.ResumeMediaInput(ctx, request.(ResumeMediaInputRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "ResumeMediaInput")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(ResumeMediaInputResponseObject); ok {
		if err := validResponse.VisitResumeMediaInputResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// StartMediaInput operation middleware
func (sh *strictHandler) StartMediaInput(w http.ResponseWriter, r *http.Request) {
	var request StartMediaInputRequestObject

	var body StartMediaInputJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.StartMediaInput(ctx, request.(StartMediaInputRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "StartMediaInput")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(StartMediaInputResponseObject); ok {
		if err := validResponse.VisitStartMediaInputResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// GetMediaInputStatus operation middleware
func (sh *strictHandler) GetMediaInputStatus(w http.ResponseWriter, r *http.Request) {
	var request GetMediaInputStatusRequestObject

	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.GetMediaInputStatus(ctx, request.(GetMediaInputStatusRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "GetMediaInputStatus")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(GetMediaInputStatusResponseObject); ok {
		if err := validResponse.VisitGetMediaInputStatusResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
// StopMediaInput operation middleware
func (sh *strictHandler) StopMediaInput(w http.ResponseWriter, r *http.Request) {
	var request StopMediaInputRequestObject

	var body StopMediaInputJSONRequestBody
	if err := json.NewDecoder(r.Body).Decode(&body); err != nil {
		sh.options.RequestErrorHandlerFunc(w, r, fmt.Errorf("can't decode JSON body: %w", err))
		return
	}
	...
	handler := func(ctx context.Context, w http.ResponseWriter, r *http.Request, request interface{}) (interface{}, error) {
		return sh.ssi.StopMediaInput(ctx, request.(StopMediaInputRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "StopMediaInput")
	}
	...
	if err != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, err)
	} else if validResponse, ok := response.(StopMediaInputResponseObject); ok {
		if err := validResponse.VisitStopMediaInputResponse(w); err != nil {
			sh.options.ResponseErrorHandlerFunc(w, r, err)
		}
	} else if response != nil {
		sh.options.ResponseErrorHandlerFunc(w, r, fmt.Errorf("unexpected response type: %T", response))
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+x9aXMbNxbgX0H1TpWlHR7yldloPjmWnGgtxy7Rnswm9HLA7kc2Rt1AB0CTol3+71t4",
	"QF9sNC9JtpXaqlRMkd3AA96Jd+FzEIo0Exy4VsHp50CCygRXgH/8RKMr+DMHpc+lFNJ8FQqugWvzkWZZ",
	"wkKqmeDD/yrBzXcqjCGl5tPfJMyC0+B/DKvxh/ZXNbSjffnypRdEoELJMjNIcGomJG7G4EsveCn4LGHh",
	"15q9mM5MfcE1SE6TrzR1MR0ZgVyAJO7BXvCr0K9EzqOvBMevQhOcLzC/ucfNaC8TFl6/EbmCAj8GgChi",
	"5kWavJMiA6mZoZsZTRT0gqz21edgmmttIWxOiEMS+yvRgjCzETTUZMl0HPQC4HkanP4RJDDTQS+QbB6b",
	"f1MWRQkEvWBKw+ugF8yEXFIZBR97gV5lEJwGSkvG52YLQwP6xH69Pv37VQZEzAg+Q2iIX1ezRmJp/syz",
	"wA3jnSAWSTS5hpXyLS9iMwaSmJ/N+syzJMrNq0THYCcOegHTkOL7rdHdF1RKujJ/8zyd4FtuuhnNEx2c",
	"Pm6hMk+nIM3iNEsBJ5eQAdWNed3oZtvngBR3017Fv0kohIwYpxp3qxyAZEIxt2ftkVbtkf7PISN96QUS",
	"/syZhMgg5SYwQ1eIENP/gmXalxKohjMmIdRCrg6j1FREHkJ5m9nXSVSMTsyD5EiEmibEoqtHYDAfkH88",
	"f348IGcWM7jx/3j+fBD0goxqw+bBafB//zjp/+Pj56e9Z1/+FnhIKqM6bgPxYqpEkmuoAWEeNDOEuPS1",
	"SYaD/9kefG03cSbfZp5BAhreUR0fto9bllAAHuE0dw/4FYRIaPPDoGdRG/aLCLi27OxIVxaT1FZCXiRZ",
	"THmegmQhEZLEqywGvo5/2v/0ov/7Sf/H/se//8272PbCmMoSujJqis33XE8MKDlba3qZSwlck8iOTexz",
	"hHGSsRtIlJexJcwkqHgiqYbtQ7qniXnaDPzLJ3KU0hWZAuF5khA2I1xoEoGGUNNpAsfeSZcs8hHU+mz4",
