...
Practical calls for the livestream API grouped by mode. All examples assume the API is reachable on `http://localhost:444` from the host (inside the container the service still binds to `10001`).
